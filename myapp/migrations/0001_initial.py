    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(blank=True, choices=[('UserExtData', 'UserExtData')], max_length=255, null=True)),
                ('status', models.SmallIntegerField(choices=[(1, 'active'), (2, 'not active')], default=1)),
            ],
            options={
