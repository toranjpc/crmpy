...
class User(AbstractUser):
    ...
    mobile = models.CharField(max_length=15, unique=True, blank=True, null=True)  # طول ۱۵ کاراکتر
    mobile_verified_at = models.DateTimeField(blank=True, null=True)
    email = models.EmailField(max_length=191, unique=True, blank=True, null=True)  # طول ۱۹۱ کاراکتر
